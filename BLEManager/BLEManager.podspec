...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/OpenGeoBase/BLEManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'OpenGeoBase' => 'riccardo.paolillo@gmail.com' }
  s.source           = { :git => 'https://github.com/OpenGeoBase/BLEManager.git', :tag => s.version.to_s }
